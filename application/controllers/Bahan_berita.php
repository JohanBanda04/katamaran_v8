...
//        $this->load->model('Guzzle_model');
    ...
    {
//        echo "index bahan berita woy";die;
...
//            echo '<pre>'; print_r($_FILES['url_files']);die;
            //echo $count; die;
//            echo $when;die;
//            echo $tanggal_convert; die;
//            echo "<pre>"; print_r($_FILES['file']['name'] = $_FILES['url_files']['name'][0]);die;
            if ($count != 0) {
                for ($i = 0; $i < $count; $i++) {
