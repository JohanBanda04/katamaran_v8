<div class="modal fade" id="add_bahan_berita">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="bd p-15"><h5 class="m-0">Tambah Bahan Berital</h5></div>
...
<script type="text/javascript">
    ...
    $("#add-more").click(function(e){
        ...
        var html3 = '<div class="form-group input-dinamis"><div class="row"><div class="col-input-dinamis col-lg-10">' +
